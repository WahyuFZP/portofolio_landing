      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-tight text-brand-text">
            Wahyu Fikri <span className="text-brand-blue">Zeni Putra</span>.
          </h1>
          ...
          <div className="flex gap-5 items-center text-brand-text/60">
            <a href="https://github.com/WahyuFZP" target="_blank" rel="noopener noreferrer" className="hover:text-brand-purple transition-colors" title="GitHub">
            ...
            <a href="https://linkedin.com/in/wahyufzp" target="_blank" rel="noopener noreferrer" className="hover:text-brand-blue transition-colors" title="LinkedIn">
          ...
          >
            ...
            >
              ...
              <div className="absolute top-10 left-10 text-white">
                <h3 className="text-3xl font-black tracking-tight">Wahyu Fikri <span className="text-brand-amber">Zeni Putra</span></h3>
                <p className="text-base font-bold text-white/80">Software Engineer</p>
              </div>
              ...
              <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between text-white p-4 bg-white/10 rounded-full shadow-lg backdrop-blur-md border border-white/10">
                <div className="flex items-center gap-3">
                  <img 
                    ...
                    alt="Foto Profil wfzputra" 
                    className="w-10 h-10 rounded-full border border-white/20 object-cover"
                  />
                  <div>
                    <p className="text-base font-black text-white/90">@wfzputra</p> 
